                                ...
                                <div class="question-content-footer">
                                    <?php
                                        if (isset($_SESSION['user_id']) && $_SESSION['user_username'] == $post['post_created_by']) {
                                            echo '<button id="add-comment-btn" class="button is-small" onclick="toggleModal(' . "'add-answer'" . ')">Add a comment</button>';
                                    ...
                                    <div class="user-card">
                                        ...
                                        <time class="user-card-time">
                                            asked
                                            <span class="relative-time text-color-uj"><?php echo time_elapsed_string($post['post_created_date']); ?></span>
                                        </time>
                                    </div>
                                </div>
                            </div>
                        ...
                        <ul class="answers">
                            ...
                            <li class="answer">
                                <div class="answer-content">
                                    ...
                                    <div class="answer-content-footer">
                                        <div class="user-card">
                                            ...
                                            <time class="user-card-time text-muted">
                                                <span><?php echo time_elapsed_string($post_answer['post_answer_created_date']); ?></span>
                                            </time>
                                        </div>
                                        <?php
                                        if (isset($_SESSION['user_id'])) {
                                            echo '<button id="add-comment-btn" class="button is-small" onclick="toggleModal(' . "'add-comment'" . ')">reply</button>';
                                        }
                                        ?>
                                    </div>
                                    ...
                                    <!-- <div class="line-separator-wrapper">
                                        <div class="line-divider"></div>
                                        <h5 class="line-separator">comments</h5>
                                        <div class="line-divider"></div>
                                    </div> -->
